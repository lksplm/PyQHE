...
coeff_zee = lambda i, j, s, p: s*1.0
Hzee = OperatorLinCy(basis, site_indices=diag_sites, spin_indices=[(0,0), (1,1)], op_func=coeff_zee)
print("Hzee hermitian: ",Hzee.is_hermitian())
...
eigsys = Eigensystem(ops_list=[H0, Hint, Hzee], param_list=[alpha, [0.25], [0.5]], M=40)
